...
@section('name')
    <div class="container">
        <h2 style="color: #730C02 ; text-decoration: underline;" class="fs-1 text-center my-5">La liste de nos rendez-vous Uro </h2>
        <div class="row">
            <div class="col-9">
                <form action="{{ route('recherche-uro') }}" method="post">
                    @csrf
                    <div class="row">
                            ...
                            <thead>
                              ...
                              <tbody class="table-group-divider">
                                @foreach ($rendez_vous as $patient)
                                    @if ($patient->specialite == "Urologue")
                                        <tr>
