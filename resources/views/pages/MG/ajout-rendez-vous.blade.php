...
@section('name')
    <div class="container">
        <div class="row">
            @if (Session::has('ok'))
                <div class="alert alert-primary  mt-5">{{ session::get('ok') }}</div>
            @endif
            @if (Session::has('ok rendez_vous'))
                <div class="alert alert-primary  mt-5">{{ session::get('ok rendez_vous') }}</div>
            @endif
        </div>
        <h2 style="color: #730C02 ; text-decoration: underline;" class="fs-3 text-start py-2 mt-5">Page de Consultation </h2>
    </div>
        <div class="">
            <div class="container">
                <div class="row">
                    <div class="col-9 "><a href="{{ route('dossier-medical', $patient->id) }}" class="btn text-light mb-3" style="background: #734E39">Voir le dossier médical du patient</a></div>
                    <div class="col"><b>Patient : </b>{{ $patient->prenom }} {{ $patient->nom }}</div>
                </div>
            <div class="row gx-3">
                <div class="col-lg-12 mb-5 mb-lg-0">
                    <div class=" text-start rounded py-3 p-4" style="background: #F2B988">

                        <h1 class="fs-3 text-start py-2  mb-2 text-light">Consultation</h1>
                                ...
                                <div class="col-9">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-sm-12 text-light">
                                           ...
                                           <div class="row me-1" id="logo1"></div>
                                           {{-- partie radio --}}
                                           <div class="form-check form-switch">
                                           ...
                                           <div class="row me-1" id="logo2"></div>
                                          {{-- partie echo --}}
                                           <div class="form-check form-switch">
                                           ...
                                           {{-- recupération formulaire radio--}}
                                           <div class="row me-1" id="logo3"></div>
                                       </div>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="row g-3">
                                        <div class="col-12 col-sm-12">
                                            <div class="form-floating">
                                                <textarea class="form-control" name="remarque" id="floatingTextarea2" style="height: 200px"></textarea>
                                                <label for="floatingInputInvalid">Resultat d'analyse / Diagnostic</label>
                                              </div>
                                        </div>
                                        <div class="col-12 col-sm-12">
                                            <div class="form-floating">
                                                <textarea class="form-control" name="traitement" id="floatingTextarea2" style="height: 200px"></textarea>
                ...
                <div class="row g-3">
                    <div class="ms-2 text-start rounded p-4" style="background: #F2B988">
                        <h1 class="col-sm-12 fs-3 text-start py-2 mb-2 text-light">Rendez-vous</h1>
                        <form action="{{ route('save-rendez-vous') }}" method="POST">
                            @csrf
                           <div class="row g-3">
                            <div class="col-12 col-sm-4">
                                <select class="form-select bg-light @error('specialite') is-invalid @enderror" name="specialite"  style="height: 55px;">>
