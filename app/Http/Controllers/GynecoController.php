...
class GynecoController extends Controller
{
    /**
    ...
    public function index()
    {
       ...
       return view('pages.Gynéco.liste_patients',[
    ...
    public function show(Request $request)
    {
        ...
        if($prenom == ""){
            return redirect()->Route('espace-diabeto');;
        }
        ...
        $patients = patients::where('prenom', 'like', "%{$prenom}%")
                            ...
                            ->paginate(4);
        // dd($patients);
        return view('pages.Gynéco.recherche-patient',[
            'patients' => $patients,
            'total' => $total
        ]);
    }
    ...
    public function recherche(Request $request)
    {
        ...
        $prenom = $request->prenom ;
        if($prenom == null){
            return redirect()->Route('gyneco-rendez-vous');
        }
